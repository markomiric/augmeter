...
Generate self-contained HTML files for technical diagrams, visualizations, and data tables. Open the result in the browser when the environment permits it; if browser launch is unavailable or not approved, report the file path and verification status. Never fall back to ASCII art when this skill is loaded.
...
**Open in browser when permitted (cross-platform):**
